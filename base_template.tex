...
\fancyfoot[C]{%
    ...
    \begin{tabularx}{\textwidth}{m{3.0cm} X m{5.0cm} }
        ...
        \makecell[tl]{\faBuilding \hspace{0.2cm} Palladium Tower İş Merkezi \\ Barbaros Mah. Kardelen Sok. Blok: 2 No: 46 \\ 34746 Ataşehir - İstanbul} &

        \makecell[tl]{\faPhone \hspace{0.2cm} +90 216 455 58 22 - 23 \\ \faFax \hspace{0.2cm} +90 216 455 58 24 \\ \faEnvelope \hspace{0.2cm} info@gen-era.com.tr}
    \end{tabularx}%
}
%%%%%%%%%%%%% HEADER FOOTER SONU %%%%%%%%%%%%%%
